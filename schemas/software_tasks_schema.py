def software_estimate_serializer(estimate) -> dict:
    return {
        ...
        "dev_ops_task": estimate["dev_ops_task"],
        ...
        "frontend_testing_task": estimate["frontend_testing_task"],
        ...
        "access_control_task": estimate["access_control_task"],
        "seo_task": estimate["seo_task"],
        "widget_setup_task": estimate["widget_setup_task"],
